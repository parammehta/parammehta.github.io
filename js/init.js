...
var matResume = function () {
    ...
    if ($('#map_canvas').length > 0) {
        var settings = {
            zoom: 13,
            center: new google.maps.LatLng(33.4216829,-111.9231692,21),
            styles: [
                {
                    "stylers": [
                        {
        ...
        var contentString = '<div id="content-map-marker" style="text-align:left; padding-top:10px; padding-left:10px">' +
            ...
            '<div id="bodyContent">' +
            '<p style="font-family:Verdana; color:#999; font-size:12px; margin-bottom:10px">Here I am. Come to drink a coffee!</p>' +
            '</div>' +
            '</div>';
        ...
        var companyPos = new google.maps.LatLng(33.4216829,-111.9231692);
...
/***** Masonryproject function start *****/
if ($('.project-wrap').length > 0) {
    var $container = $('.portf'),
        $body = $('body');


    /*On Resize project Function*/
    var onResizePort = function () {
        $body.find('.portf').each(function () {
            ...
            if (winWidth >= 1466) {
                ...
                $('.project-wrap').css({width: container_mock});
                $('.project-wrap.no-gutter').css({width: container_mock});
                $('.project-wrap.no-gutter.full-width').css({width: 100 + '%'});
                var projectWidth = $('.project-wrap').width();

                if (typeof attr_col !== typeof undefined && attr_col !== false) {
                    columnNumb = $(this).attr('data-col');
                } else columnNumb = 3;

                var postWidth = Math.floor(projectWidth / columnNumb)
                ...
                postWidth = Math.floor(projectWidth / columnNumb)
                $(this).find('.item').each(function () {
